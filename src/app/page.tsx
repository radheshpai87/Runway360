          ...
          <div className="flex-1 flex flex-col gap-8 animate-fadeIn w-full">
            ...
            {activeTab === "runway" && (
              <InteractiveSandbox
                ...
                sandboxTimeline={sandboxTimeline}
                setSandboxExpenses={setSandboxExpenses}
                setSandboxSavings={setSandboxSavings}
                setSandboxTimeline={setSandboxTimeline}
                liveRunway={liveRunway}
                liveBuffer={liveBuffer}
                liveShortfall={liveShortfall}
